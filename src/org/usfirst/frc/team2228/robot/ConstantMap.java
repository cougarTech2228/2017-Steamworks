...
public final class ConstantMap {
	...
	public enum AutoChoices {
		DO_NOTHING, BASE_LINE_TIME_SENSOR, CENTER_GEAR_PLACEMENT, RIGHT_GEAR_PLACEMENT, LEFT_GEAR_PLACEMENT, VISION_GEAR_LEFT, VISION_GEAR_RIGHT, CENTER, GEAR_PLACEMENT_DREAM
	}
