...
public final class ConstantMap {
	...
	public enum AutoChoices {
		...
		VISION_GEAR_RIGHT, CENTER, GEAR_PLACEMENT_DREAM, GEAR_AND_FUEL_PLACEMENT_LEFT, DRIVE_TO_DA_PIN, GEAR_AND_FUEL_PLACEMENT_RIGHT, TURN_LEFT, TURN_RIGHT, DRIVE_STRAIGHT_THEN_TURN
	}
