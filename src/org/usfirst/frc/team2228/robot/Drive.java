...
public class Drive
{
	...
	private Gear gear;
	private VictorSP fuelFurnaceDispenser;
	...
	public enum Goal
	{
		DO_NOTHING, TURN_GEAR_PLACEMENT, VISION_PLACEMENT, CENTER, BASE_LINE, GEAR_PLACEMENT, GEAR_PLACEMENT_DREAM, VISION_GEAR_RIGHT, VISION_GEAR_LEFT, GEAR_AND_FUEL_PLACEMENT_LEFT
	}
	...
	public enum State
	{
		INIT, WAIT_FOR_TIME, DONE, TURN, GEAR_PLACEMENT, 
		VISION_ALIGNMENT, VISION_SECOND, MOVE_TO_LIFT, PLACE_GEAR, BACK_UP, DISPENSE_DA_FUEL
	}
...
//				}
	...
	public void teleopPeriodic()
	{
		...
		else if (!(joystick1.getRawAxis(3) > .8
				|| joystick1.getRawAxis(2) > .8))
	...
	private double smoothMove(double value)
	{
		double smoothFactor = 2.0 / (ConstantMap.timePeriodSF + 1);
		double newEMA = oldEMA + smoothFactor * (value - oldEMA);
		oldEMA = newEMA;
		return newEMA;
	}
}
